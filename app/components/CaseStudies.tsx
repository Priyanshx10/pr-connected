    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100">
      ...
      >
          ...
          {caseStudies.map((study, index) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <a
                  href="#"
                  className="text-teal-500 font-semibold hover:text-teal-600 transition duration-300 inline-flex items-center"
                >
                  Read More
        ...
        >
          ...
          <a
            href="/contact"
            className="bg-teal-500 text-white font-bold py-3 px-6 rounded-full hover:bg-teal-600 transition duration-300 inline-flex items-center"
          >
            Get in Touch
            <ArrowRight className="ml-2" />
          </a>
